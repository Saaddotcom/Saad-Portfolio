...
export default function Contact() {
  return (
    <section id="contact" className="section contact" style={{ maxWidth: '72rem', margin: '0 auto', padding: '5rem 5vw' }}>
     ...
     <div className="section-title" style={{ fontFamily: 'var(--font-heading)', fontSize: 'clamp(1.5rem, 7vw, 2.5rem)', fontWeight: 700, margin: '0 0 0.5rem 0', color: 'var(--text)', lineHeight: 1.2 }}>
